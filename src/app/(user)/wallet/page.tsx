  ...
  return (
    <div>
      ...
      <div className="grid gap-6 lg:grid-cols-[360px_1fr]">
        <section className="rounded-[32px] border border-[#e6e7ef] bg-white/78 p-7 text-[#151515] shadow-[0_28px_90px_rgba(21,21,21,0.08)] backdrop-blur-xl">
          ...
          <h2 className="mt-2 text-6xl font-black tracking-[-0.04em]">{user.points}</h2>
          <div className="mt-6 h-3 overflow-hidden rounded-full bg-[#e6e7ef]">
            <div className="h-full w-[68%] rounded-full bg-[#151515]" />
          </div>
        ...
        <section className="eco-card rounded-[32px] p-6 lg:col-span-2">
          <div className="flex items-center gap-3">
            <span className="grid size-11 place-items-center rounded-xl bg-[#e8fbff] text-[#00687a]">
              <History size={20} />
            </span>
          ...
          <div className="mt-4 grid gap-3">
            {transactions.map((transaction) => (
              <div className="flex items-center justify-between gap-4 rounded-2xl border border-[#e6e7ef] bg-white p-4" key={transaction.id}>
                <div>
