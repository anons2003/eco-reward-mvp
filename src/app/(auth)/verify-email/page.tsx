  ...
  return (
    ...
    >
      ...
      <form action="/api/auth/resend-verification" className="mt-5 grid gap-4" method="post">
        ...
        <PendingSubmitButton className="focus-ring flex min-h-14 w-full cursor-pointer items-center justify-center gap-2 rounded-full bg-[#007a3d] px-5 py-4 font-black text-white shadow-[0_14px_34px_rgba(0,106,61,0.22)] transition hover:bg-[#006a35] active:scale-[0.99] disabled:cursor-wait disabled:opacity-80" pendingLabel="Đang gửi..." type="submit">
