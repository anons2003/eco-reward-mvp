...
export default async function AdminSubmissionDetailPage({ params }: { params: Promise<{ id: string }> }) {
  ...
  return (
    <div>
      <PageHeader eyebrow="Submission detail" title="Chi tiết lượt gửi" body="Xem tín hiệu AI, QR/bin, điểm và risk flags trước khi duyệt." />
      <div className="grid gap-6 lg:grid-cols-[1fr_360px]">
      <section className="eco-card rounded-[28px] p-6">
        <div className="flex items-start justify-between">
          <div>
            <p className="text-sm font-bold uppercase text-[#166534]">AI result</p>
        ...
        <div className="mt-6 grid gap-4 md:grid-cols-2">
          <div className="rounded-2xl bg-white p-4">
            <p className="text-sm text-[#5f6472]">AI confidence</p>
        ...
        <div className="mt-6 rounded-2xl bg-[#fff7e6] p-4">
          <p className="font-bold text-[#92400E]">Risk flags</p>
